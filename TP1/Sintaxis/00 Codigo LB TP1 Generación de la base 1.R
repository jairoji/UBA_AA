...
setwd("/home/sergio/Documents/Research/Data Mining FCEN/clases/AA/TP1/datos")  
...
latino11 <- read.spss("Latinobarometro_2011_esp.sav", to.data.frame = T, reencode = 'UTF-8')
# Preselección de variables
latino11 = latino11[,-c(3:35)]
latino11 = latino11[,-c(369:ncol(latino11))]  
# Filtro de registros: países de Sudamérica
...
base.final[,"P10ST"] = recode(base.final[,"P10ST"], "c('Está estancado', 'Está en retroceso') = 'No está progresando'")
base.final[,"S1NICC7"] = recode(base.final[,"S1NICC7"], "c('Nada', 'Poco') = 'Poco - Nada'")

base.final[,"P49ST.A"] = recode(base.final[,"P49ST.A"], "c('01 No es democrático', '2', '3') = 'No Democrático';
                              c('4', '5', '6', '7') = 'Ni Demo-Ni No Demo'; c('8', '9', '10 Totalmente democrático') = 'Democrático'")

#base.final[,"P49ST.B"] = recode(base.final[,"P49ST.B"], "c('01 No es democrático', '2', '3') = 'No Democrático';
#                              c('4', '5', '6', '7') = 'Ni Demo-Ni No Demo'; c('8', '9', '10 Totalmente democrático') = 'Democrático'")

#base.final[,"P49ST.E"] = recode(base.final[,"P49ST.E"], "c('01 No es democrático', '2', '3') = 'No Democrático';
#                              c('4', '5', '6', '7') = 'Ni Demo-Ni No Demo'; c('8', '9', '10 Totalmente democrático') = 'Democrático'")
